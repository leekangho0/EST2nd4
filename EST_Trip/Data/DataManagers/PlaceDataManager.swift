...
class PlaceDataManager {
    ...
    func insertPlace(name: String, address: String, latitude: Double, longitude: Double, category: String, scheduleID: UUID) {
        ...
        newPlace.category = Int16()
        newPlace.scheduleID = scheduleID

        saveContext()
    }

    
    func update(entity: PlaceEntity, with newName: String) {
        entity.name = newName
        saveContext()
        
    }
    
    func delete(entity: PlaceEntity) {
